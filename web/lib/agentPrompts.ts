...
웹 검색 2~3회. 검색마다 구체적 수치·날짜·이름·기록 등 팩트 수집.
검색 언어: 한국 관련 주제는 한국어로, 해외·글로벌 주제는 영어로 검색.
인물·선수·기업 주제라면: 커리어·성적·수상·이슈·최근 동향 반드시 검색.
찾은 것만 기록. 없는 건 추측하지 말고 소스에 포함하지 않음.
각 소스 URL 필수 — 찾을 수 없으면 "검증불가" 표기.
key_facts는 반드시 6개 이상, 각 팩트는 수치·날짜·고유명사를 포함한 구체적 문장으로.
\`\`\`json
{"sources": [{"title": "...", "summary": "...", "url": "실제URL또는검증불가"}], "key_facts": ["구체적팩트(수치포함)", "팩트2", "팩트3", "팩트4", "팩트5", "팩트6"], "unverified_count": 0}
\`\`\``,
